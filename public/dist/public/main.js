...
module.exports = "<h1>Favorite authors</h1>\n<a href=\"\" [routerLink]=\"['']\">Home</a>\n<p>Edit this author</p>\n<p *ngIf=\"submitted == true\">Successfully Updated!</p>\n<div class='container' *ngIf=\"submitted == false\">\n  <form (submit)=\"onEdit(editingObject._id)\">\n    <label>Name:</label>\n    <input type=\"text\" name=\"editingObject.name\" [(ngModel)] = \"editingObject.name\" value=\"editingObject.name\">\n    <button [routerLink]=\"['']\">Cancel</button>\n    <button type=\"submit\">Submit</button>\n  </form>\n</div>"
...
var EditComponent = /** @class */ (function () {
    function EditComponent(_route, _router, _httpService, _http) {
        this._route = _route;
    ...
    EditComponent.prototype.collect = function (id) {
        var _this = this;
        var observable = this._httpService.getPrimary(id);
        observable.subscribe(function (data) {
            _this.editingObject = data['data'][0];
        });
    };
    EditComponent.prototype.onEdit = function (id) {
        var _this = this;
        var observable = this._httpService.editPrimary(id, this.editingObject);
        observable.subscribe(function (data) {
            _this.editingObject = data;
            _this.collect(id);
...
module.exports = "<h1>Favorite authors</h1>\n<a [routerLink]=\"['/new']\">Add an author</a>\n<p>We have quotes by:</p>\n<table>\n  <thead>\n    <th>Author</th>\n    <th>Actions available</th>\n  </thead>\n  <tbody>\n    <tr *ngFor=\"let author of primaryCollection\">\n      <td>{{author.name}}</td>\n      <td>\n        <button (click)=\"onEdit(author._id)\" [routerLink]=\"['/edit', author._id]\">Edit</button> |\n        <button (click)=\"onButtonDel(author._id)\">Delete</button>\n      </td>\n    </tr>\n  </tbody>\n</table>"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(_route, _router, _httpService, _http) {
        this._route = _route;
        this._router = _router;
        this._httpService = _httpService;
        this._http = _http;
    ...
    HomeComponent.prototype.getPrimaryCollection = function () {
        var _this = this;
        var observable = this._httpService.getPrimaries();
        observable.subscribe(function (data) {
            _this.primaryCollection = data['data'];
            _this.primaryCollection.sort(function (a, b) {
    ...
    HomeComponent.prototype.onButtonDel = function (id) {
...
var NewComponent = /** @class */ (function () {
    function NewComponent(_route, _router, _httpService, _http) {
        this._route = _route;
        this._router = _router;
        this._httpService = _httpService;
        this._http = _http;
    ...
    NewComponent.prototype.onSubmit = function () {
        var _this = this;
        var observable = this._httpService.addNew(this.newAuthor);
        observable.subscribe(function (data) {
            console.log(data);
...
module.exports = __webpack_require__(/*! /Users/alvinho/Desktop/authors/public/src/main.ts */"./src/main.ts");
